...
class Categories extends \Magento\Framework\View\Element\Template implements BlockInterface
{
    ...
    public function __construct(
        ...
        \PragmaticDigital\Categories\Helper\Data $categoriesHelper,
        ...
        if (!empty($catIds)) {
            foreach ($catIds as $catId) {
                ...
                if ($category->getIsActive()) {
                    ...
                    $imgCatUrl = $category->getPragmaticDigitalCategoryImage();
                    $catImgUrl = "";
                    ...
                    $listCategories[$catId]['short_description'] = $category->getPragmaticDigitalCategoryDescription();
                }
            }
        }
