...
namespace PragmaticDigitalTech\ProductTabs\Helper;
...
use PragmaticDigitalTech\ProductTabs\Block\ProductTabs;
...
class Data extends AbstractHelper
{
    ...
    public function __construct(
        ...
        \PragmaticDigitalTech\ProductTabs\Block\ProductTabs $block
    )
    {
    ...
    private function getProductImages($product, $_config, $prefix = 'img')
    {
        ...
        $_placeholder = ($placeholder != '' && strpos($placeholder, 'http') !== false) ? $placeholder : $this->_block->getViewFileUrl('PragmaticDigitalTech_ProductTabs::images/nophoto.jpg');
    ...
    public function _getImageThumbnail($image)
    {
        ...
        $placeholder = $this->_block->getViewFileUrl('PragmaticDigitalTech_ProductTabs::images/nophoto.jpg');
