...
namespace PragmaticDigitalTech\ProductTabs\Block;
...
{
    const CACHE_TAGS = 'PragmaticDigitalTech_PRODUCT_TABS';
    ...
    public function getCacheKeyInfo()
    {
        ...
        return [
            'BLOCK_PragmaticDigitalTech_PRODUCT_TABS',
    ...
    protected function _prepareLayout()
    {
        ...
        $this->getLayout()->addBlock(
            'PragmaticDigitalTech\ProductTabs\Block\Product\Renderer\Listing\Configurable',
            $name_layout . '.colorswatches',
            $name_layout . '.renderlist',
            'configurable'
        )->setTemplate('PragmaticDigitalTech_ProductTabs::product/listing/renderer.phtml')->setData(['tagid' => $this->_tagId()]);
    }
    ...
    protected function _toHtml()
    {
        ...
        if ($this->_isAjax()) {
            if ($this->_getConfig("style") == "list") {
                $template_file = "PragmaticDigitalTech_ProductTabs::default_items_list.phtml";
            } else {
                $template_file = "PragmaticDigitalTech_ProductTabs::default_items.phtml";
            }
        } else {
            $template_file = $this->getTemplate();
            $template_file = (!empty($template_file)) ? $template_file : "PragmaticDigitalTech_ProductTabs::default.phtml";
        }
